...
package com.bookcase.system.bookadmin.controller;
...
public class BookAuthorController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "path", name = "anthorId", dataType = "String", required = true, value = "作者Id", defaultValue = "") })
